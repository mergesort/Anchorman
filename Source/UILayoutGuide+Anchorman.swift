...
public extension UILayoutGuide {
    ...
    /// - Returns: An `NSLayoutConstraint` between the current `UILayoutGuide` and another `UIView`.
    @discardableResult
    func set(relativeSize sizeAnchor: SizeAnchor, toSizeAnchor: SizeAnchor, ofLayoutGuide layoutGuide: UILayoutGuide, multiplier: CGFloat, constant: CGFloat, relation: NSLayoutRelation, isActive: Bool) -> NSLayoutConstraint {
    ...
    /// - Returns: An `NSLayoutConstraint` between the current `UILayoutGuide` and another `UIView`.
    @discardableResult
    func set(relativeSize sizeAnchor: SizeAnchor, toSizeAnchor: SizeAnchor, ofView view: UIView, multiplier: CGFloat, constant: CGFloat, relation: NSLayoutRelation, isActive: Bool) -> NSLayoutConstraint {
